...
console.log("$" + totalCost(30, 40, 3, 0)); // $150 without discount

/* Further Adventures
 *
 * 1) What is the cost for 12 hours work?
 */
console.log("$" + totalCost(30, 40, 12, 0)); // $510 without discount
 ...
 *    It should now be $130 for 3 hours.
 */
console.log("$" + totalCost(30, 40, 3, 20)); // $130 with $20 discount
